...
from piper import PiperVoice, utils  # PiperVoice doğrudan import edildi
...
# Model yolları (xdcx klasörü ana dizinde varsayılarak)
PIPER_MODEL_DIR = os.path.expanduser("~/xdcx/models")  # ~/xdcx/models/ altında olmalı
...
def synthesize_speech(text):
    try:
        wav = voice.synthesize(text)  # PiperVoice ile sentezle
