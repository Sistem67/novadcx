...
tts_config_path = "/root/.local/share/tts/ttsmodels/config.yaml"
tts_model_path = "/root/.local/share/tts/ttsmodels/tr_model.onnx"
...
# Yayın URL kontrol
if len(sys.argv) < 2:
    print("Kullanım: python3 hata4.py <m3u8_link>")
    sys.exit(1)
