...
logger = logging.getLogger('FastTranslator')

# Performans sabitleri
SAMPLE_RATE = 16000
CHUNK_SIZE = 4000
BUFFER_SECONDS = 4  # 4 saniyelik buffer
            ...
            if recognizer.AcceptWaveform(data):
                ...
                if text:
                    ...
                    if (len(text_buffer) >= MIN_WORDS and 
                        ...
                        translated = await translate_to_turkish(clean_text)
...
async def main(url):
    ...
    print("\n\033[1;36mHIZLI TÜRKÇE ÇEVİRİ SERVİSİ\033[0m")
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description='Hızlı Türkçe Çeviri Servisi')
